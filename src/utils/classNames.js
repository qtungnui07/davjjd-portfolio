...
var n = (e, t) => {
  ...
  ne = (e) => ({ cache: y(e.cacheSize), parseClassName: w(e), sortModifiers: te(e), ...c(e) }),
  T = /\s+/,
  re = (e, t) => {
    let {
        parseClassName: n,
  ...
  De = O(() => {
    ...
    return {
      ...
      classGroups: {
        ...
        'text-decoration-thickness': [{ decoration: [L, `from-font`, `auto`, K, W] }],
        ...
        'bg-image': [
          {
            bg: [
              `none`,
              {
                linear: [{ to: [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`] }, R, K, U],
                radial: [``, K, U],
                conic: [R, K, U],
              },
              be,
        ...
        'will-change': [{ 'will-change': [`auto`, `scroll`, `contents`, `transform`, K, U] }],
        fill: [{ fill: [`none`, ...N()] }],
