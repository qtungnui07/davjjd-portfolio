      ...
      children: [
        ...
        (0, h.jsx)(`div`, {
          ...
          children: (0, h.jsx)(r, {
            ...
            imageSrc: `/44d0242d-7f8d-4fce-9a75-6a15a447ef71.jpg`,
            socialLinks: [
              { icon: `Facebook`, label: `Facebook`, href: `https://www.facebook.com/share/14pdYryv1HM/` },
              { icon: `Youtube`, label: `YouTube`, href: `https://www.youtube.com/@davjiid` },
              { icon: `Instagram`, label: `Instagram`, href: `https://www.instagram.com/rdavjd/` },
              { icon: `CircleDot`, label: `osu!`, href: `https://osu.ppy.sh/users/34537896` },
            ],
          }),
        }),
        (0, h.jsx)(`div`, {
        ...
        (0, h.jsx)(s, {
          ...
          socialLinks: [
            { icon: `Facebook`, href: `https://www.facebook.com/share/14pdYryv1HM/` },
            { icon: `Youtube`, href: `https://www.youtube.com/@davjiid` },
            { icon: `Instagram`, href: `https://www.instagram.com/rdavjd/` },
            { icon: `CircleDot`, href: `https://osu.ppy.sh/users/34537896` },
          ],
        }),
      ],
    }),
