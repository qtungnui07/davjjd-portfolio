...
function addVietnamFlag() {
  ...
  if (!badgeLabel || badgeLabel.dataset.vietnamFlag || !badgeLabel.textContent.includes('Vietnam')) {
    return;
  }
  ...
  star.setAttribute('d', 'M14 3.1l2.05 6.3h6.63l-5.36 3.89 2.05 6.31L14 15.7 8.63 19.6l2.05-6.31L5.32 9.4h6.63L14 3.1z');
