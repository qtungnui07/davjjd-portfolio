import { a as e, i as t, o as n, r, t as i } from './jsxRuntime.js';
...
var oe = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
  ...
  le = se(ce),
  ue = oe(le),
  de = (e) => (e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * le(e) : 0.5 * (2 - 2 ** (-10 * (e - 1)))),
...
var M = {
    now: () => (
      Oe === void 0 && M.set(j.isProcessing || g.useManualTiming ? j.timestamp : performance.now()),
      Oe
    ),
    set: (e) => {
...
var Ye = { test: Ue(`#`), parse: Je, transform: qe.transform },
  ...
  Ze = Xe(`vh`),
  Qe = Xe(`vw`),
  $e = { ...F, parse: (e) => F.parse(e) / 100, transform: (e) => F.transform(e * 100) },
  et = {
    test: Ue(`hsl`, `hue`),
  ...
  L = {
    ...
    transform: (e) =>
      typeof e == `string` ? e : e.hasOwnProperty(`red`) ? qe.transform(e) : et.transform(e),
    getAnimatableNone: (e) => {
      let t = L.parse(e);
...
function nt(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(Be)?.length || 0) + (e.match(tt)?.length || 0) > 0
  );
}
var rt = `number`,
  it = `color`,
...
function Ht({
  ...
  let s = 5 / e,
    c = Bt(i, a, s);
  if (((e = E(e)), isNaN(c))) return { stiffness: B.stiffness, damping: B.damping, duration: e };
  {
    let t = c ** 2 * r;
    ...
    tick(e, t = !1) {
      ...
      if (u) {
        ...
        (!n && e >= 1 && (n = 1),
          n === 1 && t--,
          (t = Math.min(t, u + 1)),
          t % 2 && (d === `reverse` ? ((n = 1 - n), f && (n -= f / o)) : d === `mirror` && (b = a)),
          (y = m(0, 1, n) * o));
      }
      let x;
      (v ? ((this.delayState.value = l[0]), (x = this.delayState)) : (x = b.next(y)),
...
function Yn({ type: e, ...t }) {
  return Jn(e) && Un() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
  ...
  nr = (e, t) =>
    t === `zIndex`
      ...
      : !!(
          typeof e == `number` ||
          Array.isArray(e) ||
          (typeof e == `string` && (R.test(e) || e === `0`) && !e.startsWith(`url(`))
        );
function rr(e) {
  let t = e[0];
...
function ir(e, t, n, r) {
  ...
  let a = e[e.length - 1],
    o = nr(i, t),
    s = nr(a, t);
  return (`${t}${i}${a}${o ? a : i}`, !o || !s ? !1 : rr(e) || ((n === `spring` || Jn(n)) && r));
}
function ar(e) {
...
function cr(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == `string` && sr.test(e[t])) return !0;
  return !1;
}
var lr = new Set([
    `color`,
...
var fr = 40,
  pr = class extends ln {
    ...
    get animation() {
      return (this._animation || (this.keyframeResolver?.resume(), Fn()), this._animation);
    }
    get duration() {
...
var vr = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  Sr = (e, { keyframes: t }) =>
    t.length > 2 ? br : Tn.has(e) ? (e.startsWith(`scale`) ? yr(t[1]) : vr) : xr;
function Cr(e, t) {
  if (e?.inherit && t) {
    let { inherit: n, ...r } = e;
    return { ...t, ...r };
...
function ui(e, t) {
  let n = ci(e);
  return (li.has(n) || (n = R), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
...
function fi(e, t, n) {
  ...
  for (; r < e.length && !i;) {
    let t = e[r];
    (typeof t == `string` && !di.has(t) && lt(t).values.length && (i = e[r]), r++);
  }
...
var Ri = new WeakMap(),
  zi,
  Bi = (e, t, n) => (r, i) =>
    i && i[0] ? i[0][e + `Size`] : Li(r) && `getBBox` in r ? r.getBBox()[t] : r[n],
...
var ba = class {
    ...
    getValue(e, t) {
      ...
      return (
        n === void 0 &&
          t !== void 0 &&
          ((n = G(t === null ? void 0 : t, { owner: this })), this.addValue(e, n)),
        n
      );
    }
    readValue(e, t) {
...
function Na(e, { x: t, y: n }) {
  (Ma(e.x, t.translate, t.scale, t.originPoint), Ma(e.y, n.translate, n.scale, n.originPoint));
}
...
var Ha = { x: `translateX`, y: `translateY`, z: `translateZ`, transformPerspective: `perspective` },
  Ua = wn.length;
function Wa(e, t, n) {
  let r = ``,
    i = !0;
...
function Ga(e, t, n) {
  ...
  if (
    (t.transform || (o || n ? (r.transform = Wa(t, e.transform, n)) : (r.transform &&= `none`)), s)
  ) {
...
function Za(e, { layout: t, layoutId: n }) {
  return (
    Tn.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!Xa[e] || e === `opacity`))
  );
}
function Qa(e, t, n) {
  let r = e.style,
  ...
  if (!r) return a;
  for (let t in r)
    (K(r[t]) || (i && K(i[t])) || Za(t, e) || n?.getValue(t)?.liveStyle !== void 0) &&
      (a[t] = r[t]);
  return a;
}
function $a(e) {
...
function Lo(e, t, n, r, i) {
  return ((e -= t), (e = Aa(e, 1 / n, r)), i !== void 0 && (e = Aa(e, 1 / i, r)), e);
}
function Ro(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  ...
  (e === a && (s -= t), (e.min = Lo(e.min, t, n, s, i)), (e.max = Lo(e.max, t, n, s, i)));
}
...
function ns(e, t, n, r, i, a) {
  i
    ? ((e.opacity = z(0, n.opacity ?? 1, is(r))), (e.opacityExit = z(t.opacity ?? 1, 0, as(r))))
  ...
  for (let i = 0; i < $o; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || ts(o) === ts(s)
        ? ((e[a] = Math.max(z(es(o), es(s), r), 0)), (F.test(s) || F.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
  ...
  return class {
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(Fs), this.animationId++);
    }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && bs(this),
    ...
    didUpdate() {
      this.updateScheduled || ((this.updateScheduled = !0), _i.read(this.scheduleUpdate));
    }
    clearAllSnapshots() {
    ...
    applyTransform(e, t = !1, n) {
      ...
      return (Da(this.latestValues) && za(r, this.latestValues, this.layout?.layoutBox), r);
    }
    removeTransform(e) {
      let t = J();
      Z(t, e);
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r;
        (n.instance &&
          (Ea(n.latestValues) && n.updateSnapshot(), (r = J()), Z(r, n.measurePageBox())),
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (Ls(a.x, e.x, n),
          ...
          s && ((this.animationValues = i), ns(i, r, this.latestValues, n, u, l)),
        ...
        (this.pendingAnimation = k.update(() => {
          ((ms.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = ss(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (N.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(_s), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        (Z(t, n), za(t, i), Mo(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
...
function Ks(e, t, n) {
  return e === `position` || (e === `preserve-aspect` && !Ao(Yo(t), Yo(n), 0.2));
}
function qs(e) {
...
var Js = xs({
  ...
  Zs = (0, s.createContext)({ transformPagePoint: (e) => e, isStatic: !1, reducedMotion: `never` });
function Qs(e = !0) {
...
function Cc(e, t, n, r) {
  let i = (0, s.useMemo)(() => {
    let n = Sc();
    return (ao(n, t, so(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function zc(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function l(n, l) {
    ...
    if (!f && typeof window < `u`) {
      Vc(d, r);
      let t = Hc(d);
      ((u = t.MeasureLayout), (p.visualElement = Ic(e, m, d, i, t.ProjectionNode, a)));
    }
    return (0, o.jsxs)(pc.Provider, {
      value: p,
      children: [
        u && p.visualElement ? (0, o.jsx)(u, { visualElement: p.visualElement, ...d }) : null,
...
function Uc(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) => (a === `create` ? r : (n.has(a) || n.set(a, zc(a, void 0, e, t)), n.get(a))),
  });
}
var Wc = (e, t) =>
    (t.isSVG ?? Tc(e)) ? new uo(t) : new eo(t, { allowProjection: e !== s.Fragment }),
  Gc = class extends Y {
    constructor(e) {
      ...
      if (
        ...
        (this.handlePointerUp = (e, t) => {
          ...
          if (
            ...
            return;
          let a = il(
            e.type === `pointercancel` ? this.lastMoveEventInfo : nl(t, this.transformPagePoint),
            this.history,
          );
...
function il({ point: e }, t) {
  return { point: e, delta: rl(e, ol(t)), offset: rl(e, al(t)), velocity: sl(t, 0.1) };
}
function al(e) {
  return e[0];
}
...
function pl(e, t) {
  let n = 0.5,
    ...
    i = Q(t);
  return (
    i > r ? (n = w(t.min, t.max - r, e.min)) : r > i && (n = w(e.min, e.max - i, t.min)),
    m(0, 1, n)
  );
}
function ml(e, t) {
...
var yl = new WeakMap(),
  bl = class {
    ...
    startAxisValueAnimation(e, t) {
      ...
      return (Br(this.visualElement, e), n.start(Dr(e, n, 0, t, this.visualElement, !1)));
    }
    stopAnimation() {
...
var Tl = class extends Y {
  ...
  Dl = class extends Y {
    ...
    mount() {
      this.removePointerDownListener = Xc(this.node.current, `pointerdown`, (e) =>
...
var jl = { pan: { Feature: Dl }, drag: { Feature: Tl, ProjectionNode: Xs, MeasureLayout: Al } };
function Ml(e, t, n) {
  let { props: r } = e;
