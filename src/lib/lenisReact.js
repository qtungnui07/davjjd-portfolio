import { o as e, t } from './jsxRuntime.js';
...
var c = class {
  ...
  advance(e) {
    ...
    if (this.duration && this.easing) {
      this.currentTime += e;
      let n = i(0, this.currentTime / this.duration, 1);
      t = n >= 1;
      let r = t ? 1 : this.easing(n);
      this.value = this.from + (this.to - this.from) * r;
    } else
      this.lerp
        ? ((this.value = o(this.value, this.to, this.lerp * 60, e)),
...
var u = class {
    ...
    constructor(e, t, { autoResize: n = !0, debounce: r = 250 } = {}) {
      ((this.wrapper = e),
        (this.content = t),
        n &&
          ((this.debouncedResize = l(this.resize, r)),
...
var h = class {
    ...
    onWheel = (e) => {
      let { deltaX: t, deltaY: n, deltaMode: r } = e,
        i = m(r, this.window.width),
        a = m(r, this.window.height);
      ((t *= i),
        (n *= a),
  ...
  _ = class {
    ...
    constructor({
      ...
      gestureOrientation: m = p === `horizontal` ? `both` : `vertical`,
      touchMultiplier: _ = 1,
      wheelMultiplier: v = 1,
      autoResize: y = !0,
      prevent: b,
      ...
      ((window.lenisVersion = r),
        window.lenis || (window.lenis = {}),
        (window.lenis.version = r),
        p === `horizontal` && (window.lenis.horizontal = !0),
        ...
        (this.virtualScroll = new h(n, { touchMultiplier: _, wheelMultiplier: v })),
    ...
    scrollTo(
      ...
      let p = e,
        m = t;
      if (typeof p == `string` && [`top`, `left`, `start`, `#`].includes(p)) p = 0;
      else if (typeof p == `string` && [`bottom`, `right`, `end`].includes(p)) p = this.limit;
      else {
        let e = null;
        if (
          (typeof p == `string`
            ? ((e = document.querySelector(p)),
              e || (p === `#top` ? (p = 0) : console.warn(`Lenis: Target not found`, p)))
    ...
    get scroll() {
      return this.options.infinite ? s(this.animatedScroll, this.limit) : this.animatedScroll;
    }
    get progress() {
...
var S = (0, v.createContext)(null),
  C = new b(null),
  w = (0, v.forwardRef)(
    (
      { children: e, root: t = !1, options: n = {}, autoRaf: r = !0, className: i = ``, ...a },
      o,
    ) => {
      let s = (0, v.useRef)(null),
        c = (0, v.useRef)(null),
        [l, u] = (0, v.useState)(void 0);
      ((0, v.useImperativeHandle)(o, () => ({ wrapper: s.current, content: c.current, lenis: l }), [
        l,
      ]),
        (0, v.useEffect)(() => {
          let e = new _({
            ...n,
            ...(s.current && c.current && { wrapper: s.current, content: c.current }),
            autoRaf: n?.autoRaf ?? r,
          });
          return (
            u(e),
      ...
      return (
        (0, v.useEffect)(() => {
          if (t && l)
            return (C.set({ lenis: l, addCallback: f, removeCallback: p }), () => C.set(null));
        }, [t, l, f, p]),
        (0, v.useEffect)(() => {
          if (!l) return;
          let e = (e) => {
              ...
              children:
                t && t !== `asChild`
                  ...
                  : (0, y.jsx)(`div`, {
                      ...
                      ...a,
                      children: (0, y.jsx)(`div`, { ref: c, children: e }),
                    }),
            })
          : null
      );
  ...
  T = {};
function E(e, t = [], n = 0) {
  let r = (0, v.useContext)(S),
    i = x(C),
    { lenis: a, addCallback: o, removeCallback: s } = r ?? i ?? T;
  return (
    (0, v.useEffect)(() => {
      if (e && o && s && a)
        return (
