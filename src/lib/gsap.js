...
var n = { autoSleep: 120, force3D: `auto`, nullTargetWarn: 1, units: { lineHeight: `` } },
    ...
    if (
      ...
      (t < 0 && Re(e, t, n, !0),
        ...
        (t >= e._tDur || t < 0) &&
          e.ratio === o &&
          (o && Fe(e, 1),
          !n && !a && (Dt(e, o ? `onComplete` : `onReverseComplete`, !0), e._prom && e._prom())));
    } else e._zTime ||= t;
  },
  Qe = function (e, t, n) {
    var r;
        ...
        l === `<` || l === `>`
          ? (c >= 0 && (n = n.replace(/=/, ``)),
            (l === `<` ? a._start : a.endTime(a._repeat >= 0)) +
              (parseFloat(n.substr(1)) || 0) * (u ? (c < 0 ? a : r).totalDuration() / 100 : 1))
          : c < 0
            ? (n in i || (i[n] = o), i[n])
  ...
  dt = function (e) {
    return (
      ...
      function (t) {
        ...
        return ut(
          t,
          n.querySelectorAll ? n : n === e ? ne(`Invalid scope`) || L.createElement(`div`) : e,
        );
      }
    );
  },
        ...
        if (!h) {
          ...
          (r === `random` && ft(h),
            ...
            (h.v = m =
              (parseFloat(t.amount) ||
                parseFloat(t.each) *
                  (w > m ? m - 1 : l ? (l === `y` ? m / w : w) : Math.max(w, m / w)) ||
                0) * (r === `edges` ? -1 : 1)),
            (h.b = m < 0 ? i - m : i),
  ...
  ht = function (e, t) {
    ...
    return (
      !n &&
        y(e) &&
        ((r = n = e.radius || s),
        e.values ? ((e = ut(e.values)), (i = !_(e[0])) && (r *= r)) : (e = mt(e.increment))),
      it(
        t,
        n
          ? g(e)
        ...
        var t = e.name,
          ...
          r =
            t && !n && e.init
              ...
              : e,
          i = { init: ie, render: wn, add: rn, kill: En, modifier: Tn, rawVars: 0 },
          a = { targetTest: 0, get: 0, getSetter: bn, aliases: {}, register: 0 };
        if ((Ht(), e !== r)) {
          if (V[t]) return;
          (Ee(r, Ee(Ae(e, i), a)),
  ...
  zt = function (e) {
    ...
    if (((Lt.lastIndex = 0), Lt.test(t)))
      return ((n = Rt.test(t)), (e[1] = It(e[1], n)), (e[0] = It(e[0], n, Ft(e[1]))), !0);
  },
  Bt,
  Vt = (function () {
    var e = Date.now,
  ...
  qt = function (e) {
    ...
    return n && t.length > 1 && n.config
      ? n.config.apply(null, ~e.indexOf(`{`) ? [Gt(t[1])] : Kt(e).split(`,`).map(we))
      : q._CE && Ut.test(e)
        ? q._CE(``, e)
        : n;
  },
    ...
    return (
      H(e, function (e) {
        for (var t in ((q[e] = R[e] = i), (q[(a = e.toLowerCase())] = n), i))
          q[a + (t === `easeIn` ? `.in` : t === `easeOut` ? `.out` : `.inOut`)] = q[e + `.` + t] =
            i[t];
      }),
      i
    );
  ...
  tn = (function () {
    ...
    return (
      ...
      (t.totalDuration = function (e) {
        return arguments.length
          ? ((this._dirty = 0),
            $e(this, this._repeat < 0 ? e : (e - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
      ...
      (t.time = function (e, t) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), e + Be(this)) % (this._dur + this._rDelay) ||
                (e ? this._dur : 0),
              t,
            )
          : this._time;
      ...
      (t.progress = function (e, t) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - e : e) + Be(this),
              t,
            )
          : this.duration()
              ...
              e
                ...
                : (Ht(),
                  ...
                  this.totalTime(
                    ...
                    this.progress() === 1 && Math.abs(this._zTime) !== c && (this._tTime -= c),
                  ))),
            this)
          : this._ps;
      }),
      ...
      (t.endTime = function (e) {
        return (
          this._start + (b(e) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1)
        );
      }),
      ...
      (t.reversed = function (e) {
        return arguments.length
          ? (!!e !== this.reversed() && this.timeScale(-this._rts || (e ? -c : 0)), this)
          : this._rts < 0;
      }),
  ...
  return (
    ...
    (o.render = function (e, t, n) {
      ...
      if ((this !== P && s > i && e >= 0 && (s = i), s !== this._tTime || n || l)) {
        if (
          (r !== this._time && o && ((s += this._time - r), (e += this._time - r)),
          (u = s),
          (v = this._start),
          (_ = this._ts),
          (h = !_),
          ...
          if (((b = this._yoyo), (m = o + this._rDelay), this._repeat < -1 && e < 0))
            return this.totalTime(m * 100 + e, t, n);
          if (
            ((u = W(s % m)),
            s === i
              ? ((p = this._repeat), (u = o))
              : ((y = W(s / m)), (p = ~~y), p && p === y && ((u = o), p--), u > o && (u = o)),
            (y = Ve(this._tTime, m)),
            ...
            if (
              ...
              this.vars.repeatRefresh && !x && ((this.invalidate()._lock = 1), (y = p)),
              (r && r !== this._time) ||
                h !== !this._ts ||
            ...
            if (((f = d._next), (d._act || u >= d._start) && d._ts && g !== d)) {
              ...
              if (
                (d.render(
                  d._ts > 0
                    ? (u - d._start) * d._ts
                    : (d._dirty ? d.totalDuration() : d._tDur) + (u - d._start) * d._ts,
                  t,
                  n,
                ),
            ...
            if (((f = d._prev), (d._act || w <= d._end) && d._ts && g !== d)) {
              ...
              if (
                (d.render(
                  d._ts > 0
                    ? (w - d._start) * d._ts
                    : (d._dirty ? d.totalDuration() : d._tDur) + (w - d._start) * d._ts,
                  t,
                  n || (a && Se(d)),
                ),
                u !== this._time || (!this._ts && !h))
        ...
        if (
          g &&
          !t &&
          (this.pause(), (g.render(u >= r ? 0 : -c)._zTime = u >= r ? 1 : -1), this._ts)
        )
        ...
        (this._onUpdate && !t && Dt(this, `onUpdate`, !0),
          ((s === i && this._tTime >= this.totalDuration()) || (!s && r)) &&
            ...
            (this._lock ||
              ((e || !o) && ((s === i && this._ts > 0) || (!s && this._ts < 0)) && Fe(this, 1),
              !t &&
                !(e < 0 && !r) &&
                (s || r || !i) &&
                (Dt(this, s === i && e >= 0 ? `onComplete` : `onReverseComplete`, !0),
      ...
      return arguments.length
        ? ((this._forcing = 1),
          !this._dp &&
            this._ts &&
            (this._start = W(
              Vt.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts),
            )),
...
var nn = function (e, t, n, r, i, a, o) {
  ...
  rn = function (e, t, r, i, a, o, s, c, l, u) {
    ...
    var d = e[t],
      f =
        r === `get`
          ? g(d)
            ? l
              ? e[t.indexOf(`set`) || !g(e[`get` + t.substr(3)]) ? t : `get` + t.substr(3)](l)
              : e[t]()
            : d
          : r,
      p = g(d) ? (l ? vn : _n) : gn,
    ...
    if (
      (h(i) &&
        ...
        i.charAt(1) === `=` && ((m = ye(f, i) + (G(f) || 0)), (m || m === 0) && (i = m))),
      !u || f !== i || cn)
    )
      return !isNaN(f * i) && i !== ``
        ? ((m = new X(
          ...
          (this._pt = m))
        : (!d && !(t in e) && te(t, i), nn.call(this, e, t, f, i, p, c || n.stringFilter, l));
  },
  an = function (e, t, n, r, i) {
    if ((g(e) && (e = pn(e, i, t, n, r)), !y(e) || (e.style && e.nodeType) || w(e) || C(e)))
  ...
  on = function (e, t, n, r, i, a) {
    ...
    if (
      V[e] &&
      (o = new V[e]()).init(i, o.rawVars ? t[e] : an(t[e], r, i, a, n), n, r, a) !== !1 &&
      ((n._pt = s = new X(n._pt, i, e, 0, 1, o.render, o, 0, o.priority)), n !== kt)
    )
      ...
      for (t._pt = t._ptCache = 0, p = (y && b(p)) || (p && !y), k = 0; k < S.length; k++) {
        if (
          ...
          I &&
            ...
            ((t._pt = j = new X(t._pt, M, L.name, 0, 1, L.render, L, 0, L.priority)),
          ...
          for (A in O)
            V[A] && (L = on(A, O, t, z, M, w))
              ? L.priority && (N = 1)
              : (R[A] = j = rn.call(t, M, A, `get`, O[A], z, w, 0, l.stringFilter));
        (t._op && t._op[k] && t.kill(M, t._op[k]),
          T &&
            t._pt &&
            ((sn = t), P.killTweensOf(M, R, t.globalTime(n)), (ee = !t.parent), (sn = 0)),
          t._pt && p && (ue[F.id] = 1));
      }
  ...
  mn = he + `repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert`,
  hn = {};
...
var Y = (function (r) {
  ...
  function o(t, a, o, s) {
    ...
    if (
      ((l._targets = E.length
        ? ge(E)
        : ne(`GSAP target ` + t + ` not found. https://gsap.com`, !n.nullTargetWarn) || []),
      (l._ptLookup = []),
      (l._overwrite = h),
      g || m || S(d) || S(f))
    ) {
      ...
      if (
        ...
        for (O = 0; O < A; O++)
          ((k = Ae(a, hn)),
            ...
            !m && A === 1 && k.delay && ((l._delay = f = k.delay), (l._start += f), (k.delay = 0)),
        ...
        if (w(g))
          ...
          for (j in k)
            for (
              ...
              ((z = R[O]),
                (B = { ease: z.e, duration: ((z.t - (O ? R[O - 1].t : 0)) / 100) * d }),
                (B[j] = z.v),
                D.to(E, B, L),
                (L += B.duration));
    ...
    return (
      ...
      a.paused && l.paused(!0),
      (p || (!d && !g && l._start === W(T._time) && b(p) && ze(e(l)) && T.data !== `nested`)) &&
  ...
  return (
      ...
      if (!a) Ze(this, e, t, n);
        ...
        if (((l = s), (g = this.timeline), this._repeat)) {
          ...
          if (
            ...
            s === i
              ? ((d = this._repeat), (l = a))
              : ((p = W(s / f)), (d = ~~p), d && d === p ? ((l = a), d--) : l > a && (l = a)),
            (m = this._yoyo && d & 1),
            m && (l = a - l),
            (p = Ve(this._tTime, f)),
          ...
          d !== p &&
            ...
            l !== f &&
            this._initted &&
            ((this._lock = n = 1), (this.render(W(f * d), !0).invalidate()._lock = 0));
        }
        if (!this._initted) {
        ...
        if (this._rEase) {
          ...
          this.ratio = h =
            this._invRatio + this._invScale * this._invEase((l - this._invTime) * this._invRecip);
        ...
        ((g && g.render(e < 0 ? e : g._dur * g._ease(l / this._dur), t, n)) ||
          ...
          this._onUpdate && !t && (o && Re(this, e, t, n), Dt(this, `onUpdate`)),
          this._repeat &&
            d !== p &&
            this.vars.onRepeat &&
            !t &&
    ...
    (s.kill = function (e, t) {
      ...
      if (this.timeline) {
        ...
        return (
          this.timeline.killTweensOf(e, t, sn && sn.vars.overwrite !== !0)._first || Ot(this),
          this.parent &&
      ...
      for (
        ...
        if (~i.indexOf(r[m]))
          for (f in ((l = o[m]),
          t === `all` ? ((c[m] = t), (d = l), (u = {})) : ((u = c[m] = c[m] || {}), (d = t)),
          d))
            ((p = l && l[f]),
              p && ((!(`kill` in p.d) || p.d.kill(f) === !0) && Pe(this, p, `_pt`), delete l[f]),
              u !== `all` && (u[f] = 1));
...
var kn = [],
    ...
    e - Mn > 2 &&
      ...
      kn.forEach(function (e) {
        var n = e.queries,
          ...
          s;
        for (a in n)
          ((i = F.matchMedia(n[a]).matches), i && (o = 1), i !== r[a] && ((r[a] = i), (s = 1)));
        ...
        return (
          this.data.forEach(function (n) {
            return n instanceof e
              ...
              : n instanceof Y && !(n.parent && n.parent.data === `nested`) && t.push(n);
          }),
          t
        );
      }),
  ...
  Rn = {
    ...
    quickTo: function (e, t, n) {
      var r,
        i = Z.to(e, Ee(((r = {}), (r[t] = `+=0.1`), (r.paused = !0), (r.stagger = 0), r), n || {})),
        a = function (e, n, r) {
    ...
    exportRoot: function (e, t) {
      ...
      for (
        ...
        ((i = r._next),
          (t || !(!r._dur && r instanceof Y && r.vars.onComplete === r._targets[0])) &&
  ...
  Bn = function (e, t) {
    ...
    for (r in t)
      for (i = n.length; i--;)
        ((a = e._ptLookup[i][r]),
          (a &&= a.d) &&
            (a._pt && (a = zn(a, r)), a && a.modifier && a.modifier(t[r], e, n[i], r)));
  },
  Vn = function (e, t) {
    return {
      name: e,
...
var Hn,
  ...
  vr = function e(t, n) {
    ...
    if (t in Xn && a) {
      ...
      (o.svg && ((this.svgo = i.getAttribute(`data-svg-origin`)), this.props.push($, n, ``)),
        (t = Q));
    }
    ...
    for (i = 0; i < e.length; i += 3)
      e[i + 1]
        ...
        : e[i + 2]
          ? (n[e[i]] = e[i + 2])
          : n.removeProperty(
              e[i].substr(0, 2) === `--` ? e[i] : e[i].replace(tr, `-$1`).toLowerCase(),
            );
    if (this.tfm) {
      ...
      (r.svg && (r.renderTransform(), t.setAttribute(`data-svg-origin`, this.svgo || ``)),
        ...
        (!i || !i.isStart) &&
          ...
          r.zOrigin &&
            n[$] &&
            ((n[$] += ` ` + r.zOrigin + `px`), (r.zOrigin = 0), r.renderTransform()),
          (r.uncache = 1)));
    }
  },
  xr = function (e, t) {
  ...
  Cr = function (e, t) {
    var n = Un.createElementNS
      ? Un.createElementNS((t || `http://www.w3.org/1999/xhtml`).replace(/^https/, `http`), e)
      : Un.createElement(e);
  ...
  Or = function (e) {
    var t = e.ownerSVGElement,
      n = Cr(`svg`, (t && t.getAttribute(`xmlns`)) || `http://www.w3.org/2000/svg`),
      r = e.cloneNode(!0),
      i;
      ...
      (t in Xn && t !== $ && (t = Q),
        n.removeProperty
          ? ((r = t.substr(0, 2)),
            ...
            n.removeProperty(r === `--` ? t : t.replace(tr, `-$1`).toLowerCase()))
          : n.removeAttribute(t));
    }
  },
  ...
  Lr = function (e, t, n, r) {
    ...
    return (
      Gn || Dr(),
      t in ir && t !== `transform` && ((t = ir[t]), ~t.indexOf(`,`) && (t = t.split(`,`)[0])),
      Xn[t] && t !== `transform`
        ? ((i = Yr(e, r)),
          (i =
            t === `transformOrigin`
        ...
        : ((i = e.style[t]),
          (!i || i === `auto` || r || ~(i + ``).indexOf(`calc(`)) &&
            (i = (Hr[t] && Hr[t](e, t, n)) || wr(e, t) || ve(e, t) || +(t === `opacity`))),
  ...
  Rr = function (e, t, r, i) {
    ...
    if (
      ...
      i === `auto` &&
        ((h = e.style[t]), (e.style[t] = i), (i = wr(e, t) || i), h ? (e.style[t] = h) : Mr(e, t)),
      (u = [r, i]),
      zt(u),
      (r = u[0]),
      (i = u[1]),
      ...
      for (; (d = k.exec(i));)
        ((g = d[0]),
          ...
          g !== (h = f[l++] || ``) &&
            ...
            y || ((y = y || n.units[t] || b), c === i.length && ((i += y), (s.e += y))),
            b !== y && (p = Ir(e, t, h, y) || 0),
            (s._pt = {
              _next: s._pt,
              p: v || l === 1 ? v : `,`,
    ...
    if (t.tween && t.tween._time === t.tween._dur) {
      ...
      if (i === `all` || i === !0) ((r.cssText = ``), (s = 1));
        ...
        for (i = i.split(`,`), c = i.length; --c > -1;)
          ((o = i[c]), Xn[o] && ((s = 1), (o = o === `transformOrigin` ? $ : Q)), Mr(n, o));
      s &&
        (Mr(n, Q),
        a &&
  ...
  Yr = function (e, t) {
    ...
    return (
      ...
      r.svg &&
        (r.uncache
          ? ((P = e.getBBox()), (l = r.xOrigin - P.x + `px ` + (r.yOrigin - P.y) + `px`), (N = ``))
      ...
      (r.x =
        u -
        ((r.xPercent =
          u && ((!t && r.xPercent) || (Math.round(e.offsetWidth / 2) === Math.round(-u) ? -50 : 0)))
      ...
      (r.y =
        ...
        ((r.yPercent =
          d &&
          ((!t && r.yPercent) || (Math.round(e.offsetHeight / 2) === Math.round(-d) ? -50 : 0)))
  ...
  ri = function (e, t) {
    ...
    ((s = parseFloat(s)),
      ...
      (p || m || h || g) &&
        ((v = U(v + p - (p * b + m * S) + h)), (y = U(y + m - (p * x + m * C) + g))),
      (r || i) &&
        ((w = f.getBBox()), (v = U(v + (r / 100) * w.width)), (y = U(y + (i / 100) * w.height))),
      ...
      if (g !== `autoRound` && ((u = t[g]), !(V[g] && on(g, t, r, i, e, a)))) {
        if (
          ...
          ((l = (getComputedStyle(e).getPropertyValue(g) + ``).trim()),
            ...
            (Lt.lastIndex = 0),
            Lt.test(l) ||
              ((_ = G(l)), (v = G(u)), v ? _ !== v && (l = Ir(e, g, l, v) + v) : _ && (u += _)),
          ...
          if (b || ((d || d === 0) && (f || f === 0) && !rr.test(u) && g in s))
            ((_ = (l + ``).substr((f + ``).length)),
              ...
              (this._pt = new X(
                ...
                f,
                (y ? ye(f, y + d) : d) - f,
                !b && (v === `px` || g === `zIndex`) && t.autoRound !== !1 ? lr : ar,
              )),
              (this._pt.u = v || 0),
              b && E !== u
