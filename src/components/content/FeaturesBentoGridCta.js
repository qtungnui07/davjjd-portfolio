...
import { t } from '../animation/ScrollReveal.js';
import { t as n } from '../../utils/classNames.js';
import { t as r } from '../animation/TextAnimation.js';
import { t as i } from './ImageOrVideo.js';
var a = e(),
  o = ({ tag: e, title: o, description: s, features: c, ctaButton: l, textAnimation: u }) => {
    let d = [`md:col-span-5`, `md:col-span-7`, `md:col-span-7`, `md:col-span-5`];
                          ...
                          children: [
                            ...
                            (0, a.jsx)(`div`, {
                              ...
                              children: (0, a.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, a.jsx)(`span`, {
                                    className: `text-primary-cta-text text-sm font-semibold mx-2 transition-transform duration-500 ease-out -translate-x-3 group-hover:translate-x-0`,
                                    children: `+`,
                                  }),
                                  (0, a.jsx)(`div`, {
              ...
              children: c.map((e, t) =>
                (0, a.jsxs)(
                  `div`,
                  {
                    className: n(
                      d[t],
                      `flex flex-col gap-3 xl:gap-3.5 2xl:gap-4 p-3 xl:p-3.5 2xl:p-4 card rounded`,
                    ),
                    children: [
                      (0, a.jsx)(`div`, {
                        className: `h-60 xl:h-72 2xl:h-80 rounded overflow-hidden bg-foreground/5 shadow shadow-foreground/5`,
                        children: (0, a.jsx)(i, { imageSrc: e.imageSrc, videoSrc: e.videoSrc }),
                      }),
                      (0, a.jsxs)(`div`, {
