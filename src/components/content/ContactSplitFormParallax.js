...
import { t as i } from '../../hooks/useScroll.js';
import { t as a } from '../../hooks/useTransform.js';
import { t as o } from '../animation/ScrollReveal.js';
...
import { t as d } from '../../utils/submitContactForm.js';
var f = e(n(), 1),
  p = t(),
  m = ({ icon: e, label: t, href: n, onClick: r }) => {
    let i = u(e);
    return (0, p.jsxs)(`a`, {
      href: n,
      onClick: s(n, r),
      ...
      children: [
        (0, p.jsx)(i, { className: `size-4`, strokeWidth: 1.5 }),
        (0, p.jsx)(`span`, { children: t }),
      ],
    });
  },
  h = ({
    ...
    let x = (0, f.useRef)(null),
      ...
      O = async (e) => {
        (e.preventDefault(), T(!0), D(null));
        try {
          (await d({ formData: S }), g?.(S));
          let e = {};
          (s.forEach((t) => {
            e[t.name] = ``;
          }),
          ...
          D(e instanceof Error ? e.message : `Failed to send. Please try again.`);
        } finally {
          T(!1);
        }
      },
      { scrollYProgress: k } = i({ target: x, offset: [`start end`, `end start`] }),
      A = a(k, [0, 0.6], [1.3, 1]);
      ...
      children: (0, p.jsx)(`div`, {
        ...
        children: (0, p.jsxs)(o, {
          ...
          children: [
                    ...
                    children: [
                      s.map((e) =>
                        (0, p.jsx)(
                          `input`,
                          {
                            ...
                            value: S[e.name] || ``,
                            onChange: (t) => C({ ...S, [e.name]: t.target.value }),
                            required: e.required,
                      ...
                      u &&
                        (0, p.jsx)(`textarea`, {
                          ...
                          value: S[u.name] || ``,
                          onChange: (e) => C({ ...S, [u.name]: e.target.value }),
                          required: u.required,
                          rows: u.rows || 5,
            ...
            (0, p.jsxs)(`div`, {
              ref: x,
              className: `relative h-100 md:h-auto card rounded overflow-hidden`,
              children: [
                (0, p.jsx)(r.div, {
                  style: { scale: A },
                  ...
                  children: (0, p.jsx)(l, {
                    imageSrc: _,
                    videoSrc: v,
                    className: `md:absolute md:inset-0 size-full object-cover`,
                  }),
                }),
                y &&
                  y.length > 0 &&
                  (0, p.jsx)(`div`, {
                    className: `absolute inset-0 flex flex-wrap items-end justify-center gap-3 p-6 xl:p-7 2xl:p-8`,
                    children: y.map((e, t) => (0, p.jsx)(m, { ...e }, t)),
                  }),
              ],
            }),
          ],
