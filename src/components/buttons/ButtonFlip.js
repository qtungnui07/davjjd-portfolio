  ...
  c = ({
    ...
    let f = i(n, c),
      ...
      g = (e) => {
        ...
        return { delay: 0.05 + r * 2.9, rotateZ: a * i * 36 * -1, translateX: n * 0.125 };
      },
      _ = (0, s.jsx)(`a`, {
        href: n,
        onClick: f,
                ...
                return (0, s.jsx)(
                  r.span,
                  {
                    ...
                    animate: p
                      ...
                      : { x: 0, y: 0, rotateX: 0, rotateZ: 0, scale: 1, opacity: 1 },
                    transition: { duration: 0.35, delay: p ? n : 0, ease: [0.675, 0.15, 0.1, 1] },
